...
INSERT INTO `aithousa` VALUES (1,'Αίθουσα 1',100),(2,'Σκηνή',772),(3,'Σκηνή',668),(4,'Αίθουσα 3',80),(5,'Σκηνή',200),(6,'Σκηνή',295);
...
CREATE TABLE `axiologisi_paragwgis_apo_theati` (
  ...
  `Βαθμολογία` decimal(2,1) unsigned NOT NULL,
...
-- Dump completed on 2019-12-22 21:43:32
